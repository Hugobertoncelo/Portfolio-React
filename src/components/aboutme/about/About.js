          ...
          <Col md={7}>
            <Fade duration={3000}>
              <p className="home-about-body">
                Meu nome é <b className="purple">Hugo da Silva Bertoncelo </b>
                e sou graduado em<b className="purple"> Análise e Desenvolvimento de Sistemas </b>
                ...
                <b className="purple">
                  {" "}
                  JavaScript, TypeScript e React no front-end, além de Node.js no back-end.{" "}
                </b>
                <br />
                <br />
                ...
                <b className="purple">Construindo novas tecnologias e produtos web. </b>
              </p>
            </Fade>
          </Col>
        </Row>
